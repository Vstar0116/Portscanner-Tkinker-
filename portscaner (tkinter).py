...
#----lables-----
L11=Label(gui,text= "V's Port scanner",font=("Ubuntu",40,'underline'))
L11.place(x=16,y=10)
...
listbox = Listbox(frame, width = 59, height = 16)
...
#-----Buttons----------
B11 = Button(gui, text = "Start Scan", 
             command=startScan)
B11.place(x = 16, y = 500, width = 170)
B21 = Button(gui, text = "Save Result", 
             command=saveScan)
